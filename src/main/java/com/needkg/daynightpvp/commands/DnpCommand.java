...
public class DnpCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!sender.hasPermission("dnp.admin")) {
            sender.sendMessage("§8[§e☀§8] §x§2§4§f§f§0§0D§x§2§0§f§f§1§8a§x§1§d§f§f§3§0y§x§1§9§f§e§4§7N§x§1§6§f§e§5§fi§x§1§2§f§e§7§7g§x§0§e§f§e§8§fh§x§0§b§f§e§a§7t§x§0§7§f§d§b§eP§x§0§4§f§d§d§6v§x§0§0§f§d§e§eP §8- §7v" + DayNightPvP.plugin.getDescription().getVersion());
            return false;
        }

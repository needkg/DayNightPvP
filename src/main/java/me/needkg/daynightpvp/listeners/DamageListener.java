...
public class DamageListener implements Listener {
    ...
    private boolean checkHooks(Player damagedPlayer, Player damager, String worldName) {
        ...
        if (DayNightPvP.isWorldGuardPresent && AllowDaytimePvpFlag.checkStateOnPosition(damagedPlayer) && AllowDaytimePvpFlag.checkStateOnPosition(damager)) {
            return false;
        }
        ...
        if (DayNightPvP.isGriefPresent && !worldSettings.getGriefPreventionPvpInLand(worldName) && griefPreventionHandler.verify(damagedPlayer, damager)) {
            return true;
        }
        return false;
    }
